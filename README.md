...
This project is created and intended to be used for the [Shopify Theme Development – Online Store 2.0 + TailwindCSS course](GioDevJS)


[Get the course!](GioDeVJS/) | [Lessons covered](#lessons-covered) |
...
```sh
shopify theme init [ NAME OF YOUR THEME ] --clone-url https://github.com/GioDevJS/giodev-br_clean.git
```
